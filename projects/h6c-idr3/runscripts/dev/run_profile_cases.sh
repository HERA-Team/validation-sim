...
uv run vsim --uv runsim ${common} --cpu --n-time-chunks 135 --simulator fftvis32 --n-unique-beams 10 --prefix h6c-idr3-profiling-fftvis-cpu --slurm-override ntasks-per-node 64
